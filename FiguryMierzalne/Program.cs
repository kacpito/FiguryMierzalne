...
namespace Figury
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            int oneDim = 0;
            double sredniePole = 0;
            int twoDim = 0;
            double sredniaObjetosc = 0;
            int threeDim = 0;
            ...
            Console.WriteLine(sredniaObjetosc);

            Console.WriteLine($"Średnia długość figur = {sredniaDlugosc / oneDim} ");
            Console.WriteLine($"Sumaryczne pole figur = {sredniePole / twoDim} ");
            Console.WriteLine($"Objętość figury największej = {sredniaObjetosc / threeDim} ");
        }
    }
}
